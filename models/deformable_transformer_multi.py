...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, class_embed = None ):
        ...
        pos_embed_list = torch.chunk(lvl_pos_embed_flatten, self.num_ref_frames + 1, dim=0)
        cur_pos_embed = pos_embed_list[0]
        ref_pos_embed_list = pos_embed_list[1:]
        ...
        valid_ratios = torch.chunk(valid_ratios, self.num_ref_frames + 1, dim=0)[0]
